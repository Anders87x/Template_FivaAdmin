(function($) {
    ...
    jQuery(document).on('ready', function() {
        ...
        // Negative Area Chart JS
        if(document.getElementById("apex-negative-area-chart")){
            var options = {
                chart: {
                    height: 350,
                    type: 'area',
        ...
        if(document.getElementById("apex-stacked-area-chart")){
            var options = {
                chart: {
                    height: 350,
                    type: 'area',
        ...
        // Area Chart - Date Time X-Axis JS
        if(document.getElementById("apex-chart-datetime-x-axis")){
            var options = {
                annotations: {
                    yaxis: [{
                        y: 30,
